...
<template>
  <Title> Все доски | Трололо </Title>

  <h1 class="text-4xl font-semibold text-gray-100 px-5 py-6">Все доски</h1>
      ...
      >
        <div class="flex flex-col h-full">
          ...
          <div class="grow-0 text-sm text-gray-300">
            ...
            {{
              board.columns.reduce((accumulator, column) => accumulator + column.tasks.length, 0)
            }}
            карт.
          </div>
        </div>
