  ...
  <section class="hero bg-primary-50 dark:bg-gray-900 flex flex-col items-center justify-center ">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
      <a href="#"
        ...
        role="alert">
        <span class="text-2xl bg-primary-600 rounded-full text-white px-4 py-0 mr-3">
          🚀
        </span>
      ...
      <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
        Мы предлагаем вам удобный и современный инструмент для создания канбан-досок онлайн. Полностью бесплатно!
      </p>
      <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
        ...
        <a href="https://github.com/hazadus/nuxt-trello-board"
          class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
          <svg class="mr-2 -ml-1 w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="32.77" height="32"
            viewBox="0 0 256 250">
            <path
      ...
      <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
        <span class="font-semibold text-gray-400 uppercase">
          Сделано с ❤️ и при помощи:
        </span>
        <div class="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
          <a href="#" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400 text-4xl">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
        ...
        <p class="text-gray-500 sm:text-xl dark:text-gray-400">
          Мы предлагаем самую передовую реализацию инструмента, применяемого в методологиях Scrum и Agile.
        </p>
      </div>
